  ...
  return (
    <header className="relative font-light overflow-hidden bg-gradient-to-tr from-[#5b2e91] to-[#ff4f97] p-8 xl:px-32 text-white gap-5 md:gap-0 flex flex-wrap justify-center items-center">
      ...
      <div className='relative z-10'>
        ...
        <svg class="inline-block fill-current h-10 w-auto mr-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Your_design" x="0px" y="0px" viewBox="0 0 4502.5 594.8" style="enable-background:new 0 0 4502.5 594.8;" xml:space="preserve">
<style type="text/css">
	.st0{fill:#FFFFFF;}
